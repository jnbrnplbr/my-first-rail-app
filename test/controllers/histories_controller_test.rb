...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference("History.count") do
      post histories_url, params: { history: { action: @history.action, description: @history.description, module_id: @history.module_id, name: @history.name } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { action: @history.action, description: @history.description, module_id: @history.module_id, name: @history.name } }
